...
class ToolManager:
    ...
    def get_tools_description(self) -> str:
        ...
        descriptions = [
            "# 可用工具\n",
            "以下為工具使用規則（其他人格與對話行為由系統 prompt 管理）。",
            "**工具使用守則：**",
            "1. 僅在使用者明確要求記帳/報銷/紀錄支出或收入，或給出金額並要求紀錄時，才呼叫記帳工具",
            "2. 一般聊天/詢問/推薦等非記帳問題，直接回答，不要提到或呼叫工具",
            "3. 不確定是否需要記帳時，先用一句簡短話確認意圖，再決定是否調用工具",
            "4. 調用工具後，只需簡短告知已完成，勿描述技術細節\n",
        ]
