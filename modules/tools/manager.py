...
class ToolManager:
    ...
    def get_tools_description(self) -> str:
        ...
        descriptions = [
            ...
            "**重要規則：**",
            "1. 只有在使用者**明確表示要記帳/報銷/紀錄支出**，或提供金額並要求紀錄時，才呼叫記帳工具",
            "2. 一般聊天、推薦、詢問意見、與記帳無關的問題，一律直接回答，不要調用工具，也不要提到工具",
            "3. 如果不確定是否需要記帳，先用一句話確認意圖，不要主動使用工具",
            "4. 所有對話必須使用繁體中文",
            "5. 調用工具後，用簡短的中文告訴使用者操作已完成，不要描述技術細節\n"
        ]
